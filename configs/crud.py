...
class BaseCrud(Generic[ModelType]):
    ...
    def get_records(self, db: Session, skip: int = 0, total_records: int = 0) -> List[ModelType]:
    ...
    def get_by_id(self, db: Session, id: int):
        """Returns a specific record based on the provided id.
        Args:
            db: The database session to query records for.
    ...
    def new_record(self, db: Session, data: dict, commit: bool = True, return_record = False) -> Any:
        ...
        Returns:
              Returns a boolean to signify successful save or the new record created..
          Raises:
              Put http exceptions here when created.
        """
    ...
    def get_filtered_records(self, db: Session, filters: dict, skip: int = 0, total_records: int = 0):
        """Dumps all records within the database fitting the provided filters if no limit is provided.
        Args:
            db: The database session to query records for.
